...
$Command = "cmd.exe"
$CommandArguments = "/c `"$PSScriptRoot\genpassNonWords.bat`""  # Use backticks to escape the inner double quotes
...
$Shortcut = $WshShell.CreateShortcut("$desktop\genpassNonWords.lnk")
